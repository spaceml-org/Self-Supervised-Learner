...
python SSL/train.py --technique SIMCLR --DATA_PATH /content/UCMerced_LandUse/Images --model imagenet_resnet18  --epochs 10 --batch_size 64 --log_name ssl

echo "Stopped SSL training at epoch 10. Will resume now from checkpoint."
python SSL/train.py --technique SIMCLR --DATA_PATH /content/UCMerced_LandUse/Images --model ./models/SIMCLR_ssl.ckpt  --epochs 20 --batch_size 64 --log_name ssl2
wait
...
python SSL/train.py --technique CLASSIFIER --DATA_PATH /content/UCMerced_LandUse/Images --model ./models/SIMCLR_ssl2.ckpt  --epochs 10  --log_name ft

echo "Stopping finetuning classifier at epoch 10. Will resume now from checkpoint."
python SSL/train.py --technique CLASSIFIER --DATA_PATH /content/UCMerced_LandUse/Images --model ./models/CLASSIFIER_ft.ckpt  --epochs 20  --log_name ft2
