...
python SpaceForceDataSearch/finetuner_dali_distrib.py --DATA_PATH merced/UCMerced_LandUse/Images --encoder models/SSL/example_merced_SSL_resumed.ckpt --batch_size 64 --num_workers 16 --epochs 10 --gpus 1 --log_name example_merced_FT 
